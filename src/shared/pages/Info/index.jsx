...
const Info = () => (
	<div className={styles.Info}>
		...
		<div className={styles.Info__inner}>
			...
			<p> При заказе от 1500₽  доставка почтой РФ БЕСПЛАТНАЯ! При заказе от 4500₽ - скидка на доставку транспортной компанией СДЭК 500₽!* В среднем доставка занимает 6-15 дней почтой россии и 2-5 рабочих дней транспортной компанией СДЕК, не считая дня отправки.</p>
