...
const Agreement = () => (
	<div className={styles.Agreement}>
		...
		<div className={styles.Agreement__inner}>
			...
			<p>
				1.1Оператор ставит соблюдение прав и свобод граждан одним из
			...
			<p>
				...
				newstep.store. Персональные данные обрабатывается в соответствии
				с ФЗ «О персональных данных» № 152-ФЗ.
			</p>
			<p />
			...
			<p>
				...
				Пользователю веб-сайта newstep.store;
			</p>
			<p>
			...
			<p>
				...
				следующей целью: Уточнение деталей и отправка заказа клиенту.
			...
			<p>
				...
				расположенные на веб-сайте newstep.store. Отправляя свои
			...
			<p>
				...
				Оператора newstep.adm@gmail.com, либо на почтовый адрес
				Оператора 344022, г.Ростов-на-Дону, д.225, с пометкой
			...
			<p>
				...
				newstep.adm@gmail.com, либо на почтовый адрес Оператора 344022,
				г.Ростов-на-Дону, д.225, с пометкой «Отзыв согласия на обработку
				персональных данных».
			</p>
			<p />
