...
import { LogoIcon, InstagramIcon, VkIcon, WhatsupIcon } from 'components/Icon';
		...
		<div className={style.ContactBlock}>
			...
			<div className={style.ContactBlock__social}>
				<a
					...
					target="_blank"
					className={style.ContactBlock__social__item}
				>
					<InstagramIcon />
				</a>
				<a
			...
			<div className={style.ContactBlock__phone}>
				<span className={style.ContactBlock__phone__label}>
					Телофоны:
				</span>

				<a
					href={data.contacts.phone.url}
					className={style.ContactBlock__phone__item}
				>
					<span className={style.ContactBlock__phone__title}>
						Ростовская обл.:
					</span>
				...
				<a
					href={data.contacts.phoneRussia.url}
					className={style.ContactBlock__phone__item}
				>
					<span className={style.ContactBlock__phone__title}>
						Россия:
